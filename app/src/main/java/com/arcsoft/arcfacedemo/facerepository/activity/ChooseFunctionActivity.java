...
import com.arcsoft.arcfacedemo.face.FaceRecognizeActivity;
...
public class ChooseFunctionActivity extends BaseActivity {
    ...
    private ActivityChooseFunctionBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_choose_function);
        binding.setActive(this);
