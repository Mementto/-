...
import com.arcsoft.arcfacedemo.databinding.ActivityRecognizeBinding;
...
public class RecognizeActivity extends AppCompatActivity {
    ...
    private ActivityRecognizeBinding binding;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_recognize);
        binding.setOut(this);
        try {
            upLoadImage();
    ...
    private void upLoadImage() throws FileNotFoundException {
        ...
        Call<ResponseBody> call = api.recognizeImage(imgPart);
